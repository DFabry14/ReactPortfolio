...
const MainPage = () => (
    <div>
        ...
        <Parallax imageSrc="https://github.com/DFabry14/ReactPortfolio/blob/master/src/images/MichiganAve.jpg?raw=true" />
        <div>
        ...
        <Parallax imageSrc="https://github.com/DFabry14/ReactPortfolio/blob/master/src/images/east.jpg?raw=true" />
        <div>
